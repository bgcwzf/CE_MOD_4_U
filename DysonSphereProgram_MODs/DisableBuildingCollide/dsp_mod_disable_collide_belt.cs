...
//MOD_PATCH_TARGET==>BuildTool_Path:CheckBuildConditions
//MOD_NEW_METHOD==>DSP_CE_MOD.DisableCollide_BuildTool_Path:new_CheckBuildConditions
//MOD_OLD_CALLER==>DSP_CE_MOD.DisableCollide_BuildTool_Path:old_CheckBuildConditions
//MOD_DESCRIPTION==>用于演示的第一个CE的MONO MOD DLL
namespace DSP_CE_MOD
{
    public class DisableCollide_BuildTool_Path : BuildTool_Path
    {
        // UIStationStorage
