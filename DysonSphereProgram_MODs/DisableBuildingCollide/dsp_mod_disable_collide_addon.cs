...
//MOD_PATCH_TARGET==>BuildTool_Addon:CheckBuildConditions
//MOD_NEW_METHOD==>DSP_CE_MOD.DisableCollide_BuildTool_Addon:new_CheckBuildConditions
//MOD_OLD_CALLER==>DSP_CE_MOD.DisableCollide_BuildTool_Addon:old_CheckBuildConditions
//MOD_DESCRIPTION==>用于演示的第一个CE的MONO MOD DLL
namespace DSP_CE_MOD
{
    public class DisableCollide_BuildTool_Addon : BuildTool_Addon
    {
        // UIStationStorage
