...
//MOD_PATCH_TARGET==>BuildTool_Inserter:CheckBuildConditions
//MOD_NEW_METHOD==>DSP_CE_MOD.DisableCollide_BuildTool_Inserter:new_CheckBuildConditions
//MOD_OLD_CALLER==>DSP_CE_MOD.DisableCollide_BuildTool_Inserter:old_CheckBuildConditions
//MOD_DESCRIPTION==>用于演示的第一个CE的MONO MOD DLL
namespace DSP_CE_MOD
{
    public class DisableCollide_BuildTool_Inserter : BuildTool_Inserter
    {
        // UIStationStorage
